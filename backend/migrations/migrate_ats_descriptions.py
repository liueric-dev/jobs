...
USAGE
    python3 migrations/migrate_ats_descriptions.py                  # report only
    python3 migrations/migrate_ats_descriptions.py --limit 200      # sample the report
    python3 migrations/migrate_ats_descriptions.py --apply          # rewrite
    python3 migrations/migrate_ats_descriptions.py --apply --platform greenhouse
