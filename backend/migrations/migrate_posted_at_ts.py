...
USAGE
    python3 migrations/migrate_posted_at_ts.py            # report, change nothing
    python3 migrations/migrate_posted_at_ts.py --apply
    python3 migrations/migrate_posted_at_ts.py --apply --all   # also recompute non-NULL
...
from lib import dbconn, text  # noqa: E402
