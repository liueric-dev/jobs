"""Tests for lib/text.py -- the heuristics and the posted_at parsing.
...
ingest/*.py. They pin current behaviour rather than proposing new
behaviour -- their job is to prove nothing changed. The llm half of the
original file is tests/test_llm.py.
