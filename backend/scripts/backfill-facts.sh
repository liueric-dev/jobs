...
#
#   ./scripts/backfill-facts.sh              # defaults below
#   EXTRACT_MAX_WORKERS=8 ./scripts/backfill-facts.sh
set -uo pipefail

# This script lives in scripts/; .env and the extract.py it calls are at the
