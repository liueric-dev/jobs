...
USAGE
    python3 jobs/migrate_ats_descriptions.py                  # report only
    python3 jobs/migrate_ats_descriptions.py --limit 200      # sample the report
    python3 jobs/migrate_ats_descriptions.py --apply          # rewrite
    python3 jobs/migrate_ats_descriptions.py --apply --platform greenhouse
...
sys.path.insert(0, os.path.join(_d, "jobs", "ingest"))

import ats  # noqa: E402  (jobs/ingest/ats.py -- the normalizers themselves)
