...
USAGE
    python3 jobs/migrate_google_ids.py            # report only, change nothing
    python3 jobs/migrate_google_ids.py --apply    # merge
    python3 jobs/migrate_google_ids.py --apply --keep-stats   # don't truncate stats
