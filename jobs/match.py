...
USAGE
    python3 jobs/match.py                 # only stale/missing rows
    python3 jobs/match.py --profile tech  # one profile
    python3 jobs/match.py --rebuild       # recompute everything, ignore versions
    python3 jobs/match.py --dry-run       # report, write nothing
"""
