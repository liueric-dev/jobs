...
USAGE
    python3 jobs/migrate_posted_at_ts.py            # report, change nothing
    python3 jobs/migrate_posted_at_ts.py --apply
    python3 jobs/migrate_posted_at_ts.py --apply --all   # also recompute non-NULL
...
from pipelib import dbconn, text  # noqa: E402
